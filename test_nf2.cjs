...
async function testEndpoints() {
  const endpoints = [
    ...
    '/api/v2/documento-fiscal?pedido=0012604710252',
    '/api/v2/documento-fiscal?pedidoId=0012604710252',
    '/api/v2/site/documento-fiscal?pedido=0012604710252',
    '/api/v2/site/pedido/0012604710252/documentoFiscal',
    '/api/v2/faturamento/pedido/0012604710252/nota-fiscal'
  ];
  for (let e of endpoints) {
    ...
    // Also log body if status is 200 and not too big
